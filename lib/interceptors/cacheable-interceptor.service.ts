...
export class CacheableInterceptor implements NestInterceptor {
  ...
  constructor(
    @Inject(CACHEABLE_MANAGER) protected readonly cacheManager: any,
  ...
  async intercept(
    ...
    const ttlValueOrFactory =
      this.reflector.get(CACHEABLE_TTL_METADATA, context.getHandler()) ??
      this.reflector.get(CACHEABLE_TTL_METADATA, context.getClass()) ??
      null;
